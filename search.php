        ...
        <div class="product-main">
          ...
          <div class="product-grid">
            ...
            $offset = ($page - 1) * $limit;
              ...
              for($search=0; $search<sizeof($search_term_array); $search++){
                ...
                if($array_length > 1) {
                  ...
                  $search_query = "SELECT * FROM products WHERE products.product_title LIKE '%{$search_term_array[$search]}%' OR products.product_desc LIKE '%{$search_term_array[$search+1]}%' ORDER BY products.product_id DESC LIMIT {$offset},{$limit}";

                }

                if($array_length == 1) {

                  $search_query = "SELECT * FROM products WHERE  products.product_title LIKE '%{$search_term_array[$search]}%' OR products.product_desc LIKE '%{$search_term_array[$search]}%' ORDER BY products.product_id DESC LIMIT {$offset},{$limit}";
            ...
            <?php
              ...
              echo "<h1 style='color:dark; margin-left:8%;border:1px solid aliceblue'>"."No record found"."</h1>";
            }
             $conn->close(); 
            ?>
